...
export const sendPreRegistration = (formData, navigateOnSuccess, setErrorMessage, setIsDisabled) => {
     fetch(preRegistrationURL, {
          ...
          .catch(error => {
               ...
               navigateOnSuccess(); // for showcase purposes
          });
}
...
// ------------------------------------------------------------------------------------------------
const sendReceipts = (files, navigateOnSuccess,
     //  setErrorMessage, setIsDisabled
     ) => {
     // console.log(files);
...
// abstract files POST
// ------------------------------------------------------------------------------------------------
const sendAbstractFiles = (files, navigateOnSuccess,
     //  setErrorMessage, setIsDisabled
      ) => {
